...
var imageData = {};
var imageDataKeys = [];
selectedBrands = 'Hallmark|Lovepop|AmericanGreetings';
...
function loadData() {
  get('brand_counts.json', function(data) {
    ...
    brandCounts = [
    {x: "Hallmark", value: brandCountsHolder["Hallmark"]},
    {x: "Lovepop", value: brandCountsHolder["Lovepop"]},
    {x: "AmericanGreetings", value: brandCountsHolder["AmericanGreetings"]}
];
  })    
...
function addWindowEventListeners() {
  ...
  window.addEventListener('hashchange', function(e) {
    ...
    marker.XPos = (((coords.x + 10280)/(17520 + 10280)) * 300) - (marker.Width / 2);
    marker.YPos = (193 - ((coords.y + 2848)/(13616 + 2848)) * 193) - marker.Height;
    ...
    clusterCounts = [
    {x: "Hallmark", value: thisClusterData["Hallmark"]},
    {x: "Lovepop", value: thisClusterData["Lovepop"]},
    {x: "AmericanGreetings", value: thisClusterData["AmericanGreetings"]}
    ]
...
mapSprite.src = "assets/images/Hallmark Full Map.png";
